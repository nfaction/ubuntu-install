...
ADDR=$(cat /etc/NetworkManager/system-connections/"`ls -t /etc/NetworkManager/system-connections | head -n 1`" | grep address | grep -v mac-address | cut -f2 -d"=" | cut -f1 -d"/")
nmtemp=$(cat /etc/NetworkManager/system-connections/"`ls -t /etc/NetworkManager/system-connections | head -n 1`" | grep address | grep -v mac-address | cut -f2 -d"=" | cut -f2 -d"/" | cut -f1 -d",")
NM=$(cdr2mask $nmtemp)
GW=$(cat /etc/NetworkManager/system-connections/"`ls -t /etc/NetworkManager/system-connections | head -n 1`" | grep address | grep -v mac-address | cut -f2 -d"=" | cut -f2 -d"/" | cut -f2 -d",")
